...
struct UpdateFoodSheet: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                AdBannerView(adUnitID: UpdateFoodSheetTopBannerId).frame(width: 320, height: 50)
                Section{
                    HStack{
                ...
                AdBannerView(adUnitID: UpdateFoodSheetBottomBannerId).frame(width: 320, height: 50)
            }
